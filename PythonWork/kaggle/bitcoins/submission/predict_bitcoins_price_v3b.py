...
# load the dataset
df = read_csv('../input/bitcoin_price_0316.csv',index_col="Date")

# sort the data from earliest to latest
df = df.iloc[::-1]
print df.head(), 'hhhhhhhhhhhhhhhhhhhh'
...
print df.info(), "iiiiiiiiiiiiiiii"
print df.tail()
...
print df.columns, 'cccccccccccccccccccccccc'
